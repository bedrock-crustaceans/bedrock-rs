...
mod inner {
    ...
    impl AsRef<dyn bedrock_protocol_core::PacketDyn> for V844 {
    ...
    #[cfg(feature = "packet-dyn")]
    impl From<V844> for Box<dyn bedrock_protocol_core::PacketDyn> {
        fn from(val: V844) -> Box<dyn bedrock_protocol_core::PacketDyn> {
            match val {
