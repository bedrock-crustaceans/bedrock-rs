...
mod inner {
    ...
    impl bedrock_protocol_core::DynPacket for V766 {
        #[inline]
        fn id(&self) -> u16 {
            match self {
    ...
    impl ProtoVersionPackets for V766 {
        ...
        type EducationSettingsPacket = crate::version::v662::packets::EducationSettingsPacket<
            Self,
        >;
        type CameraAimAssistPresetsPacket = crate::version::v766::packets::CameraAimAssistPresetsPacket<
            Self,
        >;
    ...
    impl ProtoVersionTypes for V766 {
        ...
        type CameraAimAssistPresetDefinition = crate::version::v766::types::CameraAimAssistPresetDefinition<
            Self,
        >;
