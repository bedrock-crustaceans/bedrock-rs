...
mod inner {
    ...
    impl AsRef<dyn bedrock_protocol_core::PacketDyn> for V712 {
    ...
    #[cfg(feature = "packet-dyn")]
    impl From<V712> for Box<dyn bedrock_protocol_core::PacketDyn> {
        fn from(val: V712) -> Box<dyn bedrock_protocol_core::PacketDyn> {
            match val {
