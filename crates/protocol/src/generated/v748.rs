...
mod inner {
    ...
    impl AsRef<dyn bedrock_protocol_core::PacketDyn> for V748 {
    ...
    #[cfg(feature = "packet-dyn")]
    impl From<V748> for Box<dyn bedrock_protocol_core::PacketDyn> {
        fn from(val: V748) -> Box<dyn bedrock_protocol_core::PacketDyn> {
            match val {
