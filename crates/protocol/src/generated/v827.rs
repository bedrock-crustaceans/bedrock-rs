...
mod inner {
    ...
    impl AsRef<dyn bedrock_protocol_core::PacketDyn> for V827 {
    ...
    #[cfg(feature = "packet-dyn")]
    impl From<V827> for Box<dyn bedrock_protocol_core::PacketDyn> {
        fn from(val: V827) -> Box<dyn bedrock_protocol_core::PacketDyn> {
            match val {
