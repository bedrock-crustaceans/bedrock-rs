...
gamepackets! {
    ...
    ClientBoundDataStore: <V898 as ProtoVersionPackets>::ClientBoundDataStorePacket,
    ...
    ServerBoundDataStore: <V898 as ProtoVersionPackets>::ServerBoundDataStorePacket,
